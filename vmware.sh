...
#Hyprland
pacstrap /mnt sddm kitty hyprland waybar hyprpaper mako foot network-manager-applet networkmanager
...
MinimumUid=1000
EOT
printf "${CYAN}[*] ${GREEN}Copying Hyprland configuration ${NC}\n"
mkdir -p /mnt/home/$2/.config/hypr
cp hyprland.conf /mnt/home/$2/.config/hypr/hyprland.conf
chown -R $2:$2 /mnt/home/$2/.config/
